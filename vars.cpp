...
int main()
{
	...
	*/
	...
	variable name is called identifier and it can be letters, numbers or _ and must start with letter or _ and can’t be any of keywords; it’s case sensitive!*/
	...
	m = 1500000000;
	m = (static_cast<double>(m) * 10) / 10; //cast is used to manually convert a variable type, it has different kinds, here we use static cast; you use it in this form static_cast(VariableNameToBeConverted), y=static_cast(x)
